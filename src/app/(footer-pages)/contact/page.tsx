  ...
  return (
    <>
      <section className="contact flex flex-col items-center justify-center">
        <header className="min-h-[270px] w-full flex items-center justify-center bg-[url('/linelogo.png')] bg-cover bg-center min-[768px]:min-h-[370px] min-[992px]:min-h-[440px] min-[1200px]:min-h-[570px]">
          <h2 className="text-[30px] font-bold min-[768px]:text-[48px] text-blue-700">
            Contact Us
          </h2>
        </header>
        <div className="contact__info pt-[60px] w-full min-[576px]:max-w-[540px] min-[576px]:px-[0px] min-[576px]:flex min-[576px]:flex-row min-[576px]:flex-wrap min-[768px]:max-w-[720px] min-[992px]:max-w-[960px] min-[1200px]:max-w-[1140px]">
          <ContactCard
            type="telephone"
            title="Telephone"
            info="+995 571 37 38 39"
          />
          <ContactCard
            type="email"
            title="Mail Address"
            info="info@linetrainer.com"
          />
          <ContactCard
            type="location"
            title="Location"
            info="Tbilisi, Georgia, Vake Plaza"
          />
        </div>
      </section>
